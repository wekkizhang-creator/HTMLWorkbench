...
export const RECORD_INDEX_PREFIX = "record-index/v1/";
export const RECORD_INDEX_DIRTY_PATH = "record-index-state/v1-dirty.json";
export const RECORD_INDEX_READY_PATH = "record-index-state/v1-ready.json";
export const RECORD_INDEX_MAINTENANCE_LOCK_PATH = "record-index-state/v1-maintenance-lock.json";
export const RECORD_INDEX_READER_LEASE_PREFIX = "record-index-state/v1-leases/readers/";
export const RECORD_INDEX_WRITER_LEASE_PREFIX = "record-index-state/v1-leases/writers/";
export const RECORD_INDEX_WRITER_LOCK_PATH = `${RECORD_INDEX_WRITER_LEASE_PREFIX}active.json`;
export const DEFAULT_PAGE_LIMIT = 50;
export const MIN_PAGE_LIMIT = 1;
export const MAX_PAGE_LIMIT = 100;
export const MAX_ZIP_UNCOMPRESSED_BYTES = 120 * 1024 * 1024;
